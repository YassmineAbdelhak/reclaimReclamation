...
const Reclamations = props => (
  <Alert color="info">
    ...
    <FormGroup row>
      ...
      <Col sm={10}> <img src={'http://localhost:5000/uploads/' + props.rec.problemImage} /* {props.rec.problemImage} */ alt="description" /><br /> </Col><br />
    </FormGroup>
    <FormGroup row>
...
export default class AllReclamation extends Component {
  ...
  reclamationList() {
    return this.state.forms.map(currentrec => {
      if ((currentrec.position == "Not Treated Yet")) {
